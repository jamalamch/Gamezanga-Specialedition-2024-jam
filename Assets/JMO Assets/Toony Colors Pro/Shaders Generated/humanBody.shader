...
Shader "Toony Colors Pro 2/humanBody"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
	...
	SubShader
	{
		...
		void surf(Input input, inout SurfaceOutputCustom output)
		{
			...
			output.Albedo = lerp(output.Albedo, float4(.5, .5, .5, 1), _Grey);
